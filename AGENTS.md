...
For product brainstorming, GitHub ticket orchestration, `/challenge`, `/build`, `/fix`, workflow-state interpretation, or continuing the project from a fresh ChatGPT conversation, read `docs/CHATGPT.md` first, then `docs/WORKFLOW.md` and `AUTOMATIONS.md` as relevant.
